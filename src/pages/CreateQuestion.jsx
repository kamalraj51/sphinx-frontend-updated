...
const CreateQuestion = () => {
  ...
  useEffect(() => {
    fetch("https://localhost:8443/sphinx/api/topic/gettopics")
      ...
      .catch((err) => toast.error("Failed to load topics"));
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("https://localhost:8443/sphinx/api/question/createquestion", {
        method: "POST",
    ...
    <Layout>
      <PremiumWrapper>
        <HeaderSection>
          ...
          <p>Build smart questions with ease using our advanced editor</p>
        </HeaderSection>
        ...
        <FormGroup>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <ChevronDown size={18} style={{ position: 'absolute', right: '16px', top: '15px', color: '#6b7280', pointerEvents: 'none' }} />
          </div>
        </FormGroup>
*/}
        <FormGroup>
