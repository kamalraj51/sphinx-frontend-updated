    ...
    <Layout>
      <PageWrap>
        ...
        <HeroBar>
          <HeroLeft>
            ...
            <div>
              ...
              <HeroSub>{decodedUserName} · {exams.length} total</HeroSub>
            </div>
          </HeroLeft>
        ...
        <Card>
          ...
          {/* Tabs */}
          <TabRow>
            <Tab $active={tab === "all"} $color="#6366f1" onClick={() => setTab("all")}>
              All
              <TabCount $bg="#eef2ff" $c="#6366f1">{exams.length}</TabCount>
            </Tab>
            <Tab $active={tab === "pass"} $color="#10b981" onClick={() => setTab("pass")}>
              ✓ Pass
              <TabCount $bg="#f0fdf4" $c="#10b981">{passed.length}</TabCount>
            </Tab>
            <Tab $active={tab === "fail"} $color="#ef4444" onClick={() => setTab("fail")}>
              ✗ Fail
              <TabCount $bg="#fef2f2" $c="#ef4444">{failed.length}</TabCount>
            </Tab>
          </TabRow>
                ...
                return (
                  ...
                  >
                    ...
                    <ExamInfo>
                      ...
                      <ExamMeta>
                        📅 {formatDate(exam.date)} &nbsp;·&nbsp; Attempt #{exam.attemptNo ?? 1} &nbsp;·&nbsp; {exam.noOfQuestions} Qs
                      </ExamMeta>
                      <ExamMeta>
                        ✅ {exam.totalCorrect} correct &nbsp;·&nbsp; ❌ {exam.totalWrong} wrong
                      </ExamMeta>
                    </ExamInfo>
